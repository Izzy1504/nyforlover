...
function App() {
    ...
    const slides = [
        ...
        {content: " Tuy nhiên đó chỉ là những khó khăn mà anh hay em phải gặp trong chuyến hành trình này nèee :3 .Nhờ đó chúng ta cũng trưởng thành hơn, yêu nhau hơn và càng thấu hiểu nhau.! "},
